...
func Load() Config {
	...
	return Config{
		...
		FrontendURL:            env("FRONTEND_URL", "https://web.smktelkom-lpg.id"),
		CORSAllowedOrigins:     splitCSV(env("CORS_ALLOWED_ORIGINS", env("FRONTEND_URL", "http://localhost:3000,http://localhost:3001,https://web.smktelkom-lpg.id,https://web-api.smktelkom-lpg.id,https://smktelkom-lpg.sch.id"))),
