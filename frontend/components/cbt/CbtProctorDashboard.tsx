    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Link
            href={`/dashboard/cbt/exams/${examId}/analysis`}
            className="flex items-center gap-1.5 px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-semibold shadow-md shadow-emerald-100 transition"
          >
            <BarChart3 className="w-3.5 h-3.5" />
            <span>Nilai & Analisis Butir</span>
          </Link>
          <button
